...
$sql = "SELECT * FROM registeration where EVENT1='Paper Presentation' OR EVENT2='Paper Presentation'";    
$result = $conn->query($sql);   
?>    
<html> 
    <head><title>REGISTERED STUDENTS</title>
...
<ul>
   ...
   <li class='active' ><a href='pp.php' >Paper Presentation</a></li>
   ...
   <li><a href='gam.php'>Gamming</a></li>
        ...
        <br>
         ...
         <form name="f2" method="POST" action="attendancePP.php" target="_parent" >
...
<td> 
  ...
  <input type="hidden" id="" value="pp.php" name="fname" required>  
