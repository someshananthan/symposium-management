...
$sql = "SELECT * FROM registeration where EVENT1='Connextions' OR EVENT2='Connextions'";    
...
<ul>
   ...
   <li><a href='web.php'>Web Designing</a></li>
    <li class='active'><a href='cc.php'>Connections</a></li>
 ...
 <form name="f2" method="POST" action="attendanceC.php" target="_parent" >
