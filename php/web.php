...
$sql = "SELECT * FROM registeration where EVENT1='Web Desigining' OR EVENT2='Web Desigining'";    
...
<ul>
   ...
   <li class='active'><a href='web.php'>Web Designing</a></li>
 ...
 <form name="f2" method="POST" action="attendanceWEB.php" target="_parent" >        
